...
exports.login = async (req, res) => {
  ...
  try {
    ...
    console.log('Stored Password:', user.password); // Log da senha armazenada
    ...
    const token = jwt.sign(
      { userId: user.userId, email: user.email, typeUser: user.typeUser },
      SECRET_KEY,
...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    console.log(`Token de redefinição gerado: ${resetToken}`); // Adiciona log do token gerado
